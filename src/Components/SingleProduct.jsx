      ...
      <div className="container-fluid my-3">
            ...
            <div id="carouselExampleIndicators" class="carousel slide">
              ...
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img src={`/products/${data.pic1}`} height="450px" className="d-block w-100" alt="..." />
                </div>
                <div className="carousel-item">
                  <img src={`/products/${data.pic2}`} height="450px" className="d-block w-100" alt="..." />
                </div>
                <div className="carousel-item">
                  <img src={`/products/${data.pic3}`} height="450px" className="d-block w-100" alt="..." />
                </div>
                <div className="carousel-item">
                  <img src={`/products/${data.pic4}`} height="450px" className="d-block w-100" alt="..." />
                </div>
              </div>
            ...
            <div className="table-rsponsive">
              <table className='table table-bordered'>
                <tbody>
                  ...
                  <tr>
                    <th>Price</th>
                    <td><del className='text-danger'>&#8377;{data.baseprice}</del> <span className='text-success'>&#8377;{data.finalprice}</span><sup>{data.discount}% OFF</sup></td>
                  </tr>
                  <tr>
                    <th>Stock</th>
                    <td>{data.stock}</td>
                  ...
                  <tr>
                    <td colSpan={2}>
                      <div className='d-flex'>
                        ...
                        <p className=' text-center fs-5' style={{ width: "10%" }}>{qty}</p>
                  ...
                  <tr>
                    <td colSpan={2}>
                      <button className='btn btn-primary w-50'><i className='fa fa-shopping-cart'>Add to Cart</i></button>
                      <button className='btn btn-success w-50'><i className='fa fa-heart'>Add to Wishlist</i></button>
                    </td>
                  </tr>
                </tbody>
              </table>
        ...
        
        {
          relatedProducts.length ?
            <>
              <h5 className='text-center my-3 bg-primary text-light p-2'>Products You May Also Like</h5>
                    ...
                    return <div key={index} className=" wow fadeInUp" data-wow-delay="0.1s">
                      <div className="team-item">
                        <div className="position-relative overflow-hidden">
                          <img className="img-fluid mt-1" src={`/products/${item.pic1}`} style={{ height: "200px", width: "100%" }} alt="" />
                          <div className="team-overlay position-absolute start-0 top-0 w-100 h-100">
                            <img src={`/products/${item.pic2}`} className="position-absolute start-0 top-0 w-100 h-100" style={{ height: "200px", width: "100%" }} alt='' />
