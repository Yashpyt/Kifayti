        ...
        <>
            <div className="container-fluid my-3">
                <div className='w-75 m-auto'>
                    <h5 className='text-center bg-primary p-2 text-light'><span className='text-warning'>Create</span> your Account</h5>
                    {
                        show?
                    ...
                    <form onSubmit={postData}>
                        ...
                        <div className="row">
                            <div className="col-md-6 mb-3">
                                <label>Email</label>
                                <input type='email' name='email' onChange={getInputData} placeholder='Email' className='form-control' />
                            </div>
