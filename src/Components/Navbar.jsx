                ...
                <div className="row gx-0 d-none d-lg-flex">
                    <div className="col-lg-4 px-5 text-start">
                        <div className="h-100 d-inline-flex align-items-center py-3 me-4">
                            ...
                            <small>Sunil Kumar Main Bazar Jhinjhana</small>
                        </div>
                    ...
                    <div className="col-lg-8 px-5 text-end">
                        <div className="h-100 d-inline-flex align-items-center py-3 me-4">
                            ...
                            <small><Link to="tel:9808956430">+91-9808956430</Link></small>
                        </div>
                        <div className="h-100 d-inline-flex align-items-center py-3 me-4">
                            <small className="fa fa-envelope text-primary me-2"></small>
                            <small><Link to="mailto:kumars15651@gmail.com">kumars15651@gmail.com</Link></small>
                        </div>
                    ...
                    </div>
                    {
                        localStorage.getItem("login") ?
                            <div className="nav-item dropdown bg-danger">
                                <a to="#" className="nav-link dropdown-toggle text-light" data-bs-toggle="dropdown">Yash Kumar</a>
