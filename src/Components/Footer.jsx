        ...
        <div className="container py-5">
            <div className="row g-5">
                <div className="col-lg-4 col-md-6">
                    ...
                    <p className="mb-2"><i className="fa fa-map-marker-alt me-3"></i>Sunil Kumar Main Bazar Jhinjhana</p>
                    <p className="mb-2"><i className="fa fa-phone-alt me-3"></i><Link className='text-light' to='tel:9808956430'>9808956430</Link></p>
                    <p className="mb-2"><i className="fa fa-envelope me-3"></i><Link className='text-light' to='mailto:kumars15651@gmail.com'>kumars15651@gmail.com</Link></p>
                ...
                <div className="col-lg-3 col-md-6">
                    ...
                    <Link className="btn btn-link" to="">Terms and conditions</Link>
