                        ...
                        <div className="container">
                            <div className="row align-items-center justify-content-center justify-content-lg-start">
                                <div className="col-10 col-lg-7 text-center text-lg-start">
                                    <h6 className="text-white text-uppercase mb-3 animated slideInDown">// Online Best Shopping Platform //</h6>
            ...
            <div className="row g-4">
                ...
                <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div className="d-flex py-5 px-4">
                        ...
                        <div className="ps-4">
                            <h5 className="mb-3">100% Orignal Products</h5>
                            <p>Diam dolor diam ipsum sit amet diam et eos erat ipsum</p>
                        </div>
                    </div>
                </div>
        ...
        <div className="container">
            <div className="row g-4">
                <div className="col-md-6 col-lg-4 text-center wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <p className="text-white mb-0">Happy Customer</p>
                </div>
