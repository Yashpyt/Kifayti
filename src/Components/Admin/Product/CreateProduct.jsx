                    ...
                    <div className="col-md-9">
                        ...
                        <form onSubmit={postData}>
                            ...
                            <div className="row">
                                ...
                                <input type="number" name='discount' min={0} placeholder='Discount' onChange={getInputData} required className='form-control'/>
                                </div>
                            </div>
                            <div className="mb-3">
                            <label>Description</label>
                            <textarea name="description" rows="4" className='form-control' onChange={getInputData} placeholder='Description' value={data.description}></textarea>
                            </div>
                            <div className="row">
                                <div className="col-md-6 mb-3">
                                <label>Pic1</label>
